...
local bach = Window:CreateTab("bach ON TOP")

local Label = bach:CreateLabel("QUER MAIS UPDATES? @bach NO YOUTUBE E TIKTOK.", 4483362458, Color3.fromRGB(255, 255, 255), false) -- Title, Icon, Color, IgnoreTheme
...
local Paragraph = VisualTab:CreateParagraph({Title = "bach ON TOP", Content = "feito por bach & equipe bach"})
...
local function applyHighlight(character)
    if character:FindFirstChildlass("Highlight") then return end 
...
local Paragraph = TeleportTab:CreateParagraph({Title = "bach ON TOP", Content = "feito por bach & equipe bach"})
...
local Paragraph = rev:CreateParagraph({Title = "bach ON TOP", Content = "feito por bach & equipe bach"})
...
local Paragraph = otoTab:CreateParagraph({Title = "bach ON TOP", Content = "feito por bach & equipe bach"})
